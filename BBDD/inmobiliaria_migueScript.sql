...
/* OJOOOOOOOOO para que me funcione he quitado las comillas al crear el user uinmueble y he quitado @'localhosht' */
CREATE USER uinmueble IDENTIFIED BY 'uinmueble';
GRANT ALL PRIVILEGES ON INMOBILIARIA_BBDD.* TO uinmueble;
FLUSH PRIVILEGES;
...
*/
/* 
si quieres saber los usuarios de mysql y el host al que está asignado
